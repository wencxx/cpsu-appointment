...
function ApproveRequests() {
  ...
  const approveRequest = async (requestId) => {
    try {
      const res = await axios.put(`${endpoint()}/approve-requests/${requestId}`);
  ...
  const handleApproveRequest = async () => {
    if (requestToApprove) {
      await approveRequest(requestToApprove);
      ...
      <AlertDialog open={openApproveDialog} onOpenChange={setOpenApproveDialog}>
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction className="bg-primary-color hover:bg-green-700" onClick={handleApproveRequest}>Approve</AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
